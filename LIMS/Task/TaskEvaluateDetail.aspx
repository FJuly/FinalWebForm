<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TaskEvaluateDetail.aspx.cs" Inherits="LIMS.Task.TaskEvaluateDetail" %>
    ...
    <script>
        window.onload = function () {
            document.getElementById("return-list").onclick = function () {
                window.location.href = "TaskEvaluate.aspx";
            }
        }
    </script>
</head>
