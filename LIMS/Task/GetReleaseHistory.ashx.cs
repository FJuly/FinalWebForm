...
{
    /// <summary>
    /// GetReleaseHistory 的摘要说明
    ///  PS 2014.10.19
    /// </summary>
    public class GetReleaseHistory : IHttpHandler, IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            else
            {
                ...
                if (context.Request.QueryString["pi"] != null)
                {
                    ...
                    {
                        //查找数据
                        TaskInformation[] taskInfo = new CTaskOperate().GetAllReleaseHistoryByPageIndex(loginer.StuNum, pageIndex, 10);
                        //转JSON格式
